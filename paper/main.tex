...
packages into an isolated directory, and \textbf{Python environments} (again,
along with dependency specification files) extend this to include a specific
...
notebook. And like separate dependency specification files used to build
virtual environments or Python environments, \texttt{Davos} provides a
convenient mechanism for fully specifying (and installing, as needed) a
