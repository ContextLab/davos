...
file~\citep[e.g., a requirements.txt or pyproject.toml; ][]{CannEtal16}.
\textbf{Python environments} (again, shared in the form of a dependency
specification file; e.g., an environment.yml) extend this idea to allow
automatically installing a specific version of Python itself. However, both of
