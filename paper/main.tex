...
\texttt{Project} instances can also be created and managed programmatically, and Davos provides additional top-level functions for viewing and working with all existing projects (see Sec.~\ref{subsec:toplevel}).
...
\item \texttt{.all\_projects}: This attribute contains a list of all Davos projects (as \texttt{Project} objects) that exist on the user's local system. See Section~\ref{subsec:projects} for more information about Davos projects.
