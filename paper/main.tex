...
\begin{abstract}
  ...
  of the project's dependencies.  The Davos package further
...
\subsubsection{The Davos config object}\label{subsec:config}

The Davos config object provides a high-level interface for
controlling various aspects of Davos's behavior. After
importing Davos, the \texttt{davos.con\-fig} object (a
...
\noindent The top-level Davos namespace also defines
convenience functions for setting and checking whether Davos
...
As of this writing, Davos can install packages using \textt{pip}, but
